...
class TaskFormActivity : AppCompatActivity(), View.OnClickListener,DatePickerDialog.OnDateSetListener {
    ...
    private val dateFormate:SimpleDateFormat = SimpleDateFormat("dd/MM/yyyy")
        ...
        viewModel.taskSave.observe(this){
            if(it.status()){
                if(taskIdentification == 0){
                    notificationToast("Tarefa criada com Sucesso")
                }else{
                    notificationToast("Tarefa Atualizada com Sucesso")
                }

                finish()
            }else{
                notificationToast(it.message())
            }
        }
    ...
    private fun notificationToast(str:String){
    ...
    override fun onDateSet(v: DatePicker, year: Int, month: Int, dayOfMonth: Int) {
        ...
        val dueDate = dateFormate.format(calendar.time)
